            ...
            <div class="card-body">
                <div class="form-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <form action="{{ route('admin.profile.change-detail') }}" method="POST" class="form form-horizontal" enctype="multipart/form-data">
                                    @csrf
                        ...
                        <div class="col-lg-6">
                            <div class="row">
                                <form action="{{ route('admin.profile.change-password') }}" method="POST" class="form form-horizontal" enctype="multipart/form-data" autocomplete="off">
                                    @csrf
                                    <div class="col-sm-12 mb-3">
                                        <h5>Detail</h5>
                                    </div>
