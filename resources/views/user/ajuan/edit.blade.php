...
<div class="page-content">
    <section class="section">
        ...
        <form id="edit_paten_form" action="{{ route('user.ajuan.update', ['patentDetail' => $patentDetail->id]) }}" method="post" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            {{-- detail --}}
            <div class="card">
            ...
            <div class="row">
                <div class="col-md-6">
                    <button id="submit_button_form" type="button" class="btn btn-primary me-3 mb-3"><i class="fa-solid fa-plus"></i> Submit</button>
...
<script>
    $("#submit_button_form").on('click', function (event){
        ...
        submitAjuan($("#edit_paten_form"));
    });

    function submitAjuan(event) {
        Swal.fire({
            title: 'Anda yakin?',
            text: "mengedit ajuan ini",
            icon: 'warning',
