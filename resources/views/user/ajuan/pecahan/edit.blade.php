                ...
                <div class="row">
                    ...
                    <div class="col form-group">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="is_fractions" id="is_fractions_yes" value="yes" @checked(old('is_fractions', $patentDetail->bool_fraction) == 'yes')>
                            <label class="form-check-label" for="is_fractions_yes">
                              Yes
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="is_fractions" id="is_fractions_no" value="no" @checked(old('is_fractions', $patentDetail->bool_fraction) == 'no')>
