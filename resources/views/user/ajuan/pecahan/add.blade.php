                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group" id="fractions_number_input">
                        <div class="input-group mb-3">
                            <input type="text" id="fractions_number" class="form-control" name="fractions_number" placeholder="Nomor Permohonan Induk" value="{{ old('fractions_number') }}">
                        </div>
                ...
                <div class="row">
                    <div class="row">
                        ...
                        <div class="col-md-8 form-group" id="fractions_date_input">
                            <div class="input-group mb-3">
                                <input type="date" id="fractions_date" class="form-control" name="fractions_date" value="{{ old('fractions_date') }}">
                            </div>
