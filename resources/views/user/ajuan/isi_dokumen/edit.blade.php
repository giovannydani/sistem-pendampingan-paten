        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <input type="text" id="invention_title_id" class="form-control" name="invention_title_id" placeholder="Judul Invensi" value="{{ old('invention_title_id', $patentDetail->PatentDocument->title_id) }}">
                        </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <input type="text" id="invention_title_en" class="form-control" name="invention_title_en" placeholder="Judul Invensi" value="{{ old('invention_title_en', $patentDetail->PatentDocument->title_en) }}">
                        </div>
        ...
        <div class="row mt-5" id="container_form_claim">
            ...
            @else
                ...
                <div class="col-md-10 form-group" id="claim_input_{{$loop->index}}">
                    <div class="input-group mb-3">
                        <textarea name="claim_add[]" id="claim_add" class="claim_add" cols="200" rows="30">{{$claim->claim}}</textarea>
                    </div>
                    
                    @error('claim_add.'.$loop->index) <span class="text-danger">{{ $message }}</span> @enderror
                </div>
                <div class="col-md-2" id="claim_delete_button_{{$loop->index}}">
                    <button type="button" class="claim btn btn-sm btn-danger" data-no={{$loop->index+1}} onclick="deleteClaimForm({{$loop->index}})"><i class="fa-solid fa-trash"></i> Hapus</button>
                </div>
                @endforeach
            @endif
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <textarea name="invention_abstract_id" id="invention_abstract_id" cols="30" rows="10" class="form-control">{{old('invention_abstract_id', $patentDetail->PatentDocument->abstract_id)}}</textarea>
                        </div>
            ...
            <div class="col-md-6">
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <textarea name="invention_abstract_en" id="invention_abstract_en" cols="30" rows="10" class="form-control">{{old('invention_abstract_en', $patentDetail->PatentDocument->abstract_en)}}</textarea>
                        </div>
