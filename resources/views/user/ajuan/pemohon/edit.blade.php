                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <input type="text" id="name_applicant" class="form-control" name="name_applicant" placeholder="Nama" value="{{ old('name_applicant', $patentDetail->PatentApplicant->name) }}">
                        </div>
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <input type="email" id="email_applicant" class="form-control" name="email_applicant" placeholder="Email" value="{{ old('email_applicant', $patentDetail->PatentApplicant->email) }}">
                        </div>
                    ...
                    <div class="col-md-8 form-group">
                        <div class="input-group mb-3">
                            <input type="text" id="no_telp_applicant" class="form-control" name="no_telp_applicant" placeholder="No Telepon" value="{{ old('no_telp_applicant', $patentDetail->PatentApplicant->telephone) }}">
                        </div>
                    ...
                    <div class="col-md-8 form-group">
                        <select class="form-select" name="nationality_id_applicant" id="nationality_id_applicant">
                            ...
                            <option value="{{$kewarganegaraan->id}}" @selected(old('nationality_id_applicant', $patentDetail->PatentApplicant->nationality_id) == $kewarganegaraan->id)>{{$kewarganegaraan->name}}</option>
                            @endforeach
                        </select>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8 form-group">
                        <select class="form-select" name="country_id_applicant" id="country_id_applicant" onchange="countryFuncAction()">
                            ...
                            @foreach ($kewarganegaraans as $kewarganegaraan)
                            <option value="{{$kewarganegaraan->id}}" @selected(old('country_id_applicant', $patentDetail->PatentApplicant->country_id) == $kewarganegaraan->id)>{{$kewarganegaraan->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-8 form-group">
                        <textarea name="address_applicant" id="address_applicant" rows="3" placeholder="Alamat" class="form-control">{{old('address_applicant', $patentDetail->PatentApplicant->address)}}</textarea>
                    ...
                    <div class="col-md-8 form-group" id="province_id_applicant_input_applicant">
                        <select class="form-select" name="province_id_applicant" id="province_id_applicant" onchange="provinceFuncAction()">
                            ...
                            <option value="{{$provinsi->id}}" @selected(old('province_id_applicant', $patentDetail->PatentApplicant->province_id) == $provinsi->id)>{{$provinsi->name}}</option>
                            @endforeach
                        </select>
...
<script>
    ...
    var selected_district = "{{ old('district_id_applicant', $patentDetail->PatentApplicant->district_id) }}";
    ...
    var selected_subdistrict = "{{ old('subdistrict_id_applicant', $patentDetail->PatentApplicant->subdistrict_id) }}";
